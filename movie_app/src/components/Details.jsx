export default function Details() {
  return (
    <div className="font-poppins bg-[#0B090A] text-[#ECF0F1] w-[840px]">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-semibold">Breaking Bad El Camino</h1>
      ...
      <div className="flex items-center gap-8 mb-6">
        <div className="min-w-52 h-78 rounded-lg bg-[url('/bbposter.jpg')] bg-cover bg-center"></div>
        <div>
          <div className="mb-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-8">
              <div>
                <p className="leading-6">Vince Gilligan</p>
                <p className="leading-6">Vince Gilligan</p>
                <p className="leading-6">Vince Gilligan</p>
              </div>
              <div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div>
          ...
          <button className="h-10 bg-[#E74C3C] rounded-lg px-8">Rate</button>
        </div>
      </div>
    </div>
  );
